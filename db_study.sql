...
-- 테이블 데이터 db_study.product_mst:~14 rows (대략적) 내보내기
DELETE FROM `product_mst`;
INSERT INTO `product_mst` (`id`, `product_name`, `product_price`) VALUES
	(1, '스타벅스 블랙 텀블러', 25000),
	(2, '스타벅스 화이트 텀블러', 30000),
	(3, '스타벅스 블루 텀블러', 15000),
	(4, '스타벅스 화이트 머그컵', 20000),
	(5, '스타벅스 블랙 머그컵', 25000),
	(6, '스타벅스 블루 텀블2러', 15000),
	(7, '스타벅스 화이트 머그컵2', 20000),
	(8, '스타벅스 블랙 머그컵2', 25000),
	(9, '스타벅스 블루 텀블21러', 15000),
	(10, '스타벅스 화이트 머그2컵2', 20000),
	(11, '스타벅스 블랙 머그컵32', 25000),
	(12, '스타벅스 블루 텀블256러', 15000),
	(13, '스타벅스 화이트 머그223컵2', 20000),
	(14, '스타벅스 블랙 머그컵31232', 25000),
	(15, '스타벅스 블루 텀블25러', 15000),
	(16, '스타벅스 화이트 머그22컵2', 20000),
	(17, '스타벅스 블랙 머그컵3132', 25000),
	(18, '스타벅스', 15000),
	(31, '스타벅스 블루 텀블225러', 15000),
	(32, '스타벅스 화이트 머그212컵2', 20000),
	(33, '스타벅스 블랙 머그컵32132', 25000),
	(34, '스타벅스ㅋㅋ', 15000);
